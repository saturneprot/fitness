...
<body>
	...
	<div id="subTitle">
		...
		<div id="rightPart">
			...
			<div class="rightItems rItem" onclick="document.location='${ctxpath}/admin/reply.do?b_num=${dto.b_num}'">답글달기</div>
		</div>
	</div>
	<div id="contentRR">
		<div class="rowR">
		...
		<div class="rowRR">
			...
			<div class="rowrow rowRT">
				<textarea style="width:100%; height:500px; border:none;" readonly>${dto.b_content }</textarea>
			</div>
		</div>
