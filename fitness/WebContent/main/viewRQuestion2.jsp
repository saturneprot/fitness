...
<body onload="onloading('${mid}','${cartT}')">
	...
	<div id="noticeR">
		<div id="noticeR-left">질문과답변</div>
		<div id="noticeR-right">
			<div class="rightItem rightItems"  onclick="document.location='${ctxpath}/main/viewQNABoard.do?flag=userQ'">목록보기</div>
			<c:if test="${mid == dto.mid}"><div class="rightItem rightItems" onclick="document.location='${ctxpath}/main/modifyRQuestion.do?b_num=${dto.b_num}'">수정하기</div></c:if>
			<c:if test="${mid == dto.mid}"><div class="rightItem rightItems" onclick="deleteQuestion('${dto.b_num}')">삭제하기</div></c:if>
		</div>
	</div>
	<div id="floor3">	
		...
		<div id="contentR">
			<div class="rowItem">
				<div class="rowR itemL1">작성자</div>
				<div class="rowR itemR1">${dto.mid}</div>
				<div class="rowR itemL1">카테고리</div>
				<div class="rowR itemR1"><c:if test="${dto.bc_num eq 1}">질문과답변</c:if></div>
			</div>
			<div class="rowItem">
				<div class="rowR itemL1">등록일</div>
				<div class="rowR itemR1">${dto.b_date}</div>
				<div class="rowR itemL1">조회수</div>
				<div class="rowR itemR1">${dto.b_count}</div>
			</div>
			<div class="rowItem">
				<div class="rowR itemL1">제목</div>
				<div class="rowR itemR1">${dto.b_subject}</div>				
			</div>
			<div class="rowItem">
				<div class="rowR itemL11">내용</div>
				<div class="rowR itemR11"><textarea style="border:none; width:100%; height:100%;" readonly>${dto.b_content}</textarea></div>
			</div>
			<div class="rowItem">
				<div class="rowR itemL111">답</div>
				<div class="rowR itemR111"><textArea style="border:none; width:100%; height:100%;" readonly>${dto.b_re}</textArea></div>
			</div>
