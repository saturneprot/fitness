...
<body onload="onloading('${mid}','${cartT}')">
	...
	<div id="noticeR">질문과답변</div>
	<div id="floor3">
	<form method="post" action="${ctxpath}/main/writeQuestionPro.do" onsubmit="return submitQuestion();">	
		<div id="writeFormBox">
			<div class="rowR">
				<input name="mid" type="hidden" value="${mid}">
				<input name="bc_num" type="hidden" value="1">
				<div class="itemT itemL1">제목</div>
				<div class="itemT itemR1"><input id="subject" name="b_subject" type="text" style="width:100%; border:none;"></div>
			</div>
			<div class="rowRR">
				<div class="itemT itemL11">내용</div>
				<div class="itemT itemR11"><textarea id="content" name="b_content" style="border:none; width:100%; height:100%"></textarea></div>
			</div>
			<div class="rowR">
				<div class="itemT itemL1">비밀번호</div>
				<div class="itemT itemR1"><input id="pwd" name="b_pwd" type="password" style="border:none;"></div>
			</div>
			<div class="rowRRR">
				<input id="submitR" type="submit" value="제  출">
				<input id="backR" type="button" value="나가기" onclick="javascript:history.back()">
			</div>
		</div>
	</form>
	</div>
