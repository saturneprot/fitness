...
<body onload="onloading('${mid}','${cartT}')">
		...
		<div id="floor1-2">
			<div id="floor1-2-left">
				...
				<div id="searchSomething" class="leftitem">
					<form name="pkc" action="${ctxpath}/main/mainList.do">
						<div id="searchCon">
							<input type="hidden" name="flag" value="sear">
							<input id="searchLeft" type="text" name="keyWord">
		...
		<div id="item1">
			...
			<div id="f2-right">
				<ul id="f2ul">
					...
					<li><a href="http://192.168.56.66/ex_test/main.jsp">카페</a></li>
	...
	<div id="containRR">
	<div id="main"><!-- 사용자에게 보여주고 싶은 영역 -->
		<img src="../mainimg/3.jpg" width="100%" height="100%">
		<!-- <div id="img">그림을 둘러싸는 div
			<img src="../mainimg/a0.jpg" width="400" height="300" class="pkc"><img src="../mainimg/a1.jpg" width="400" height="300" class="pkc"><img src="../mainimg/a2.jpg" width="400" height="300" class="pkc"><img src="../mainimg/a3.jpg" width="400" height="300" class="pkc"><img src="../mainimg/a4.jpg" width="400" height="300" class="pkc"><img src="../mainimg/a5.jpg" width="400" height="300" class="pkc"><img src="../mainimg/a6.jpg" width="400" height="300" class="pkc"><img src="../mainimg/a7.jpg" width="400" height="300" class="pkc">
		</div> -->
	</div>
	</div>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img id="mainimg" src="../mainimg/a0.JPG">
				</div>
				<div class="item">
					<img id="mainimg" src="../mainimg/a1.JPG">
				</div>
				<div class="item">
					<img id="mainimg" src="../mainimg/a2.JPG">
				</div>
				<div class="item">
					<img id="mainimg" src="../mainimg/a4.JPG">
				</div>
				<div class="item">
					<img id="mainimg" src="../mainimg/a5.JPG">
				</div>
			</div>
		</div>
	</div> -->
