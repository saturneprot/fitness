...
<body>
	<div id="mainCart">
	<form name="pkc" method="post" action="${ctxpath}/main/orderProductPro22.do" onsubmit="return checkAllThings();">
	<div id="logo" onclick="document.location='${ctxpath}/main/main.do'"><span id="logo0">운동</span>&nbsp;<span id="logo1">중</span><span id="logo2">독</span><span id="logo3">자</span><span id="logo4">들</span></div>
		...
		<div id="buyerF">
			...
			<table>
				<tr>
					...
					<td width="400" class="infoTd"><input id="mname" type="text" value="${mdto.mname}"></td>
					<td><input type="hidden" name="mid" value="${mdto.mid}"></td>
				</tr>
				<tr>
					<td align="right" class="orderTd">휴대폰 번호</td>
					<td width="400" class="infoTd"><input id="mnumber" type="text" value="${mdto.mnumber}"></td>
				</tr>
				<tr>
					<td align="right" class="orderTd">이메일</td>
					<td width="400" class="infoTd"><input id="memail" type="text" value="${mdto.memail}"></td>
				</tr>
			</table>
		</div>
		...
		<div id="receiverF">
			...
			<table style="clear:both;">
				...
				<tr>
					<td width="80" align="right" class="orderTd">배송 요청사항</td>
					<td><input type="text" name="o_comment" size="40"></td>
				</tr>
			</table>
		</div>
		...
		<!-- <div id="deleveryF"> -->
			...
			<table id="purchaseTable">
				...
				<%-- <c:set var="map2" value="<%= new HashMap<String, String>() %>" scope="request" /> --%>
						...
						<tr>
							<td width="500"><div style="float:left;">${p_name}</div><div style="float:right">${quantity}개</div></td>
							<td><input type="hidden" name="p_num" value="${p_num}"></td>
							<td><input type="hidden" name="quantity" value="${quantity}"></td>
		...
		<div id="payF">
			...
			<table id="payTable">
				<tr>
					<td width="80">총상품가격</td><td style="padding-left:10px;"><fmt:formatNumber value="${p_price*quantity}" pattern="#,###" />원</td>
				</tr>
				<tr>
					<td width="80">배송비</td><td style="padding-left:10px;"><fmt:formatNumber value="${2500}" pattern="#,###" />원</td>
				</tr>
				<tr>
					<td width="80">총결제금액</td><td style="padding-left:10px;"><fmt:formatNumber value="${p_price*quantity+2500}" pattern="#,###" />원</td>
				</tr>
				<tr>
